import { DoctorSuspensionImpact } from './admin-doctors.models';
...
export class AdminDoctorsApi {
  ...
  suspensionImpact(doctorId: string): Observable<DoctorSuspensionImpact> {
    return this.http.get<DoctorSuspensionImpact>(`${this.doctorsUrl}/${encodeURIComponent(doctorId)}/suspension-impact`);
  }
