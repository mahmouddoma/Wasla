...
import { RowVersionRequest } from '../../../domains/doctor-practices';
import {
...
export class DoctorReceptionsApi {
  ...
  listPermissions(): Observable<ReceptionAssignmentPermission[]> {
    return this.http.get<ReceptionAssignmentPermission[]>(`${this.url}/assignable-permissions`);
  }
